    ...
    <div class="layuimini-main">
        <div class="layui-row layui-col-space15">
                                ...
                                <div class="welcome-module">
                                    <div class="layui-row layui-col-space10 layuimini-qiuck">
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="http://localhost:8888/sso-client1" target="_blank" data-title="菜单管理" data-icon="fa fa-window-maximize">
                                                <i class="fa fa-window-maximize"></i>
                                                <cite>子系统一</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="http://localhost:9999/sso-client2" target="_blank" data-title="系统设置" data-icon="fa fa-gears">
            ...
            <div class="layui-col-md4">
                <div class="layui-card">
                    <div class="layui-card-header"><i class="fa fa-fire icon"></i>框架介绍</div>
