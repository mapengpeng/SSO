...
<div class="layui-container">
    <div class="admin-login-background">
        <div class="layui-form login-form">
            ...
            <form class="layui-form" action="${request.contextPath}/login<#if RequestParameters['service']??>?service=${RequestParameters['service']}</#if>" method="post">
...
<#--                        <img id="captchaPic" src="${request.contextPath}/captcha" onclick="changeCaptcha()">-->
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <h6 style="color: red">${Request["errMsg"]!}</h6>
                </div>
                <div class="layui-form-item">
...
<script src="${request.contextPath}/js/jq-module/jquery.particleground.min.js" charset="utf-8"></script>
<script>
    ...
    function changeCaptcha() {
        $('#captchaPic').attr('src', '${request.contextPath}/captcha?' + new Date().getTime())
    }
</script>
</body>
</html>